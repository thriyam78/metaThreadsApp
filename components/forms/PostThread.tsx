                ...
                <FormField
                    ...
                    render={({ field }) => (
                        <FormItem className="flex flex-col items-left gap-3 w-full ">
                            <FormLabel className="text-base-semibold text-light-2">Content of the Thread</FormLabel>
                            <FormControl className="no-focus border border-dark-4 bg-dark-3 text-white">
                                <textarea
                                    rows={15}
                                    {...field} />
                            </FormControl>
